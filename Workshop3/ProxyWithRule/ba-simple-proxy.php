<?PHP
// Passing the provider parameter along for checking
session_start();
...
// Ugly hack to check if you come from Google and try to access Facebook

else if($_SESSION['provider'] == "Google" && $url == "http://www.facebook.com") {
    $contents = 'Forbidden: You are not allowed to go there';
    $status = array('http_code' => 'Forbidden');
}
else {
